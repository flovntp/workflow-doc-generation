...
* [`organization:sub`script`ion:list`](#organizationsub`script`ionlist)
...
* [`sub`script`ion:info`](#sub`script`ioninfo)
...
* `--no-interaction`
  Don't ask any interactive questions; accept default values. Equivalent to using the environment variable: PLATFORMSH_CLI_NO_INTERACTION=1
...
* `--type` (`-t`) (expects a value)
  Filter by type (when selecting a default activity). Values may be split by commas (for example "a,b,c") and/or whitespace. The % or * characters can be used as a wildcard for the type, for example '%var%' to select variable-related activities.

* `--exclude-type` (`-x`) (expects a value)
  Exclude by type (when selecting a default activity). Values may be split by commas (for example "a,b,c") and/or whitespace. The % or * characters can be used as a wildcard to exclude types.
...
* `--state` (expects a value)
  Filter by state (when selecting a default activity): `in_progress`, `pending`, `complete` or `cancelled`. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.

* `--no-header`
  Don't output the table header
...
* `--type` (`-t`) (expects a value)
  Filter activities by type For a list of types see: https://docs.platform.sh/integrations/activity/reference.html#type Values may be split by commas (for example "a,b,c") and/or whitespace. The first part of the activity name can be omitted, for example 'cron' can select 'environment.cron' activities. The % or * characters can be used as a wildcard, for example '%var%' to select variable-related activities.

* `--exclude-type` (`-x`) (expects a value)
  Exclude activities by type. Values may be split by commas (for example "a,b,c") and/or whitespace. The first part of the activity name can be omitted, for example 'cron' can exclude 'environment.cron' activities. The % or * characters can be used as a wildcard to exclude types.
...
* `--state` (expects a value)
  Filter activities by state: `in_progress`, `pending`, `complete` or `cancelled`. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: id*, created*, de`script`ion*, progress*, state*, result*, completed, environments, time_build, time_deploy, time_execute, time_wait, type (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: name*, type*, disk, path, size (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--live`
  Live backup: Don't stop the environment. If set, this leaves the environment running and open to connections during the backup. This reduces downtime, at the risk of backing up data in an inconsistent state.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: created, domains, expires, id, issuer. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: author, date, sha, summary. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: name*, ssl*, created_at*, registered_name, replacement_for, type, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--no-clone-parent`
  Don't clone the parent environment's data

* `--no-checkout`
  Don't check out the branch locally
...
When a {{ vendor/name }} environment is deleted, it will become "inactive": it will
...
* `environment`(optional; multiple values allowed)
  The environment(s) to delete. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--no-delete-branch`
  Don't delete any Git branch(es) (inactive environments)

* `--type` (expects a value)
  Delete all environments of a type (adding to any others selected) Values may be split by commas (for example "a,b,c") and/or whitespace.

* `--only-type` (`-t`) (expects a value)
  Only delete environments of a specific type Values may be split by commas (for example "a,b,c") and/or whitespace.

* `--exclude` (expects a value)
  Environment(s) not to delete. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.

* `--exclude-type` (expects a value)
  Environment type(s) of which not to delete Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* Initialize using the {{ vendor/name }} Go template:
```
...
* `--no-inactive` (`-I`)
  Don't show inactive environments
...
* `--type` (expects a value)
  Filter the list by environment type(s). Values may be split by commas (for example "a,b,c") and/or whitespace.

* `--format` (expects a value)
  The output format: `table`, `csv`, `tsv`, or `plain`

* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: `id*`, `title*`, `status*`, `type*`, `created`, `machine_name`, `updated` (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `type`(optional)
  The log type, for example "access" or "error"
...
* `--no-clone-parent`
  Don't clone the parent branch's data (only used with --activate)
...
* `--type` (expects a value)
  Filter activities by type. Values may be split by commas (for example "a,b,c") and/or whitespace.

* `--exclude-type` (`-x`) (expects a value)
  Exclude activities by type. Values may be split by commas (for example "a,b,c") and/or whitespace. The % or * characters can be used as a wildcard to exclude types.
...
* `--state` (expects a value)
  Filter activities by state. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: id*, created*, de`script`ion*, type*, state*, result*, completed, progress, time_build, time_deploy, time_execute, time_wait (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--server-project` (expects a value)
  The project (for example 'namespace/repo')

* `--repository` (expects a value)
  The repository to track (for example 'owner/repository')
...
* `--events` (expects a value)
  A list of events to act on, for example environment.push

* `--states` (expects a value)
  A list of states to act on, for example `pending`, `in_progress`, `complete`
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: id, summary, type. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--no-clean`
  Don't remove old builds

* `--no-archive`
  Don't create or use a build archive

* `--no-backup`
  Don't back up the previous build

* `--no-cache`
  Disable caching

* `--no-build-hooks`
  Don't run post-build hooks

* `--no-deps`
  Don't install build dependencies locally
...
* `--pipe`
  Output the current group name (Don'thing else).
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: timestamp*, service*, used*, limit*, percent*, type (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: definition, path. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--full`
  Don't limit the length of command to display. The default limit is 24 lines.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: service*, name*, start*, role, stop (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
Organizations allow you to manage your {{ vendor/name }} projects, users and billing. Projects are owned by organizations.
...
* `--label` (expects a value)
  The full name of the organization, for example "ACME Inc."
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: name*, label*, owner_email*, created_at, id, owner_id, owner_username, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
## `organization:sub`script`ion:list`

List sub`script`ions within an organization
...
* `--columns` (expects a value)
  Columns to display. Available columns: id*, project_id*, project_title*, project_region*, created_at, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (expects a value)
  Columns to display. Available columns: id*, email*, owner*, permissions*, created_at, first_name, last_name, updated_at, username (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
A project sub`script`ion will be requested, and then checked periodically (every
...
* `--no-set-remote`
  Don't set the new project as the remote for this repository
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: route*, type*, to*, url (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: disk, name, size, type. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--type` (expects a value)
  The export type, for example "csv"
...
* `--eval` (expects a value)
  Pass a Java`script` fragment to the shell
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: app, command, operation. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
explicitly. For unattended `script`s, remember to turn off interaction via
--yes or the PLATFORMSH_CLI_NO_INTERACTION environment variable.

#### Options

* `--refresh-only`
  Only refresh the certificate, if necessary (Don't write SSH config)
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: id*, title*, path*, fingerprint (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
Read or modify sub`script`ion properties

### Usage

```
platform sub`script`ion:info [-s|--id ID] [--date-fmt DATE-FMT] [--format FORMAT] [-c|--columns COLUMNS] [--no-header] [-p|--project PROJECT] [--] [<property>] [<value>]
```
...
* View all sub`script`ion properties:
```
platform sub`script`ion:info 
```

* View the sub`script`ion status:
```
platform sub`script`ion:info status
```

* View the storage limit (in MiB):
```
platform sub`script`ion:info storage
```
...
* `--no-check-unique`
  Don't error if another team exists with the same label in the organization

* `--role` (`-r`) (expects a value)
  Set the team's project and environment type roles Values may be split by commas (for example "a,b,c") and/or whitespace. The % or * characters may be used as a wildcard.
...
* `--columns` (expects a value)
  Columns to display. Available columns: id*, label*, member_count*, project_count*, project_permissions*, created_at, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `projects`(optional; multiple values allowed)
  The project ID(s). Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (expects a value)
  Columns to display. Available columns: id*, title*, granted_at*, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (expects a value)
  Columns to display. Available columns: id*, email*, created_at*, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: port*, project*, environment*, app*, relationship*, url (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--role` (`-r`) (expects a value)
  The user's project role ('admin' or 'viewer') or environment type role (for example 'staging:contributor' or 'production:viewer'). To remove a user from an environment type, set the role as 'none'. The % or * characters can be used as a wildcard for the environment type, for example '%:viewer' to give the user the 'viewer' role on all types. The role can be abbreviated, for example 'production:v'.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: email*, name*, role*, id*, granted_at, permissions, updated_at (* = default columns). The character "+" can be used as a placeholder for the default columns. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--prefix` (expects a value)
  The variable name's prefix which can determine its type, for example 'env'. Only applicable if the name does not already contain a prefix. (for example 'none' or 'env:')
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: is_enabled, level, name, value. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
...
* `--columns` (`-c`) (expects a value)
  Columns to display. Available columns: commands, name, type. The % or * characters may be used as a wildcard. Values may be split by commas (for example "a,b,c") and/or whitespace.
